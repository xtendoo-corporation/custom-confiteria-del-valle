...
class TestRawMaterialInUse(TransactionCase):
    ...
    def test_01_create_raw_material_in_use(self):
        ...
        self.assertTrue(raw_material.is_in_use)
    ...
    def test_04_finish_raw_material(self):
        ...
        self.assertFalse(raw_material.is_in_use)
    ...
    def test_06_auto_close_previous_active(self):
        """Test: Al crear nuevo registro activo, el anterior se cierra automáticamente"""
        ...
        # Crear segunda materia prima activa para el mismo producto
        # NO debe lanzar error, sino cerrar la anterior
        ...
        self.assertFalse(raw_material_1.is_in_use)  # El primero se debió cerrar
        self.assertTrue(raw_material_1.date_to)
        # La fecha de cierre del 1 debe ser (aprox) la fecha de inicio del 2
        self.assertAlmostEqual(
            raw_material_1.date_to, raw_material_2.date_from, delta=timedelta(seconds=1)
        )
